...
def load_resume_data():
    ...
    # Use current working directory (set by service workdir)
    base_path = os.getcwd()
    
    # Fallback: check if files exist in script directory
    script_dir = os.path.dirname(os.path.abspath(__file__))
    
    # Determine which path has the files
    ...
    if not os.path.exists(index_path):
        index_path = os.path.join(script_dir, "resume.index")
